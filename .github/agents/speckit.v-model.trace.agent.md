---
description: Build a Bidirectional Traceability Matrix with five-matrix output (Matrix
  A Validation + Matrix B System Verification + Matrix C Integration Verification
  + Matrix D Implementation Verification + Matrix H Hazard Traceability) and coverage
  audit.
handoffs:
...
scripts:
  sh: .specify/scripts/bash/setup-v-model.sh --json --require-reqs --require-acceptance
  ps: .specify/scripts/powershell/setup-v-model.ps1 -Json -RequireReqs -RequireAcceptance
---
