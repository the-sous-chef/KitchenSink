...
/** For JWT claims and Auth0 payloads — same canonical value as UserId, named for Auth0 convention. @deprecated use UserId for DB types, keep UserSub for public API types */
