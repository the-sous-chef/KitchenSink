 ...
 *
 * Source spec: specs/003-auth0-user-auth/spec.md FR-013, FR-014, FR-015, FR-016
 * Research: specs/003-auth0-user-auth/research.md §3 (reconciliation as safety net)
 */
