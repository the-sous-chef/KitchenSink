...
**Files**: `src/recipes/import/import.controller.ts`, `src/recipes/import/import.service.ts`, `src/recipes/import/dto/import-url.dto.ts`

---

### T-004 · Schema.org Extractor: JSON-LD Recipe extraction

**Priority**: P1 | **Effort**: M | **Depends on**: T-003
...
**Files**: `src/recipes/import/extractors/schema-org.extractor.ts`, `tests/unit/extractors/schema-org.extractor.spec.ts`

---

### T-005 · Fallback Extractors: Microdata → RDFa → Heuristic HTML

**Priority**: P1 | **Effort**: L | **Depends on**: T-004
...
**Files**: `src/recipes/import/extractors/microdata.extractor.ts`, `src/recipes/import/extractors/rdfa.extractor.ts`, `src/recipes/import/extractors/heuristic.extractor.ts`, `src/recipes/import/extractors/extractor.interface.ts`

---

### T-006 · Deduplication Logic: Source URL uniqueness enforcement

**Priority**: P1 | **Effort**: S | **Depends on**: T-003
...
**Files**: `src/recipes/import/import.service.ts`
...
- [ ] `PAYWALLED_DOMAINS` list defined in `src/recipes/import/paywall.config.ts` (includes `cooking.nytimes.com`, `epicurious.com` per plan.md)
...
- [ ] Unit tests: known paywalled domain, unknown domain, subdomain of paywalled domain

**Files**: `src/recipes/import/paywall.config.ts`, `src/recipes/import/paywall.service.ts`
...
**What**: NestJS endpoint to import a recipe from an uploaded JSON, YAML, or Markdown file.
...
- [ ] Supported formats: `.json`, `.yaml`/`.yml`, `.md`
- [ ] Validates against `RecipeSchema` (Zod, plan.md §5)
...
**Files**: `src/recipes/import/import.controller.ts`, `src/recipes/import/parsers/json.parser.ts`, `src/recipes/import/parsers/yaml.parser.ts`, `src/recipes/import/parsers/markdown.parser.ts`

---

### T-009 · API Endpoint: `POST /v1/recipes/import/instagram`

**Priority**: P2 | **Effort**: M | **Depends on**: T-003, T-004
...
**Files**: `src/recipes/import/instagram.service.ts`, `src/recipes/import/dto/import-instagram.dto.ts`
...
**Files**: `src/recipes/clone/clone.controller.ts`, `src/recipes/clone/clone.service.ts`

---

### T-011 · Attribution Display: Web UI component

**Priority**: P1 | **Effort**: S | **Depends on**: T-003, T-004
...
**Files**: `src/web/components/RecipeAttribution/RecipeAttribution.tsx`, `src/web/components/RecipeAttribution/RecipeAttribution.test.tsx`

---

### T-012 · Import UI: Web import flow

**Priority**: P1 | **Effort**: M | **Depends on**: T-003, T-008, T-009, T-010
...
**Files**: `src/web/features/import/ImportModal.tsx`, `src/web/features/import/ImportModal.test.tsx`, `tests/e2e/import-url.spec.ts`

---

### T-013 · Import UI: Mobile import flow (React Native / Expo)

**Priority**: P2 | **Effort**: M | **Depends on**: T-012
...
**Files**: `src/mobile/screens/ImportScreen.tsx`, `src/mobile/screens/ImportScreen.test.tsx`

---

### T-014 · Integration Tests: Import pipeline end-to-end

**Priority**: P1 | **Effort**: M | **Depends on**: T-003–T-013
...
**Files**: `tests/integration/import/`, `tests/e2e/import-url.spec.ts`
...
**Priority**: P3 | **Effort**: L | **Depends on**: T-002, T-013
...
- [ ] OCR provider selection documented in `src/recipes/import/ocr/README.md`

**Files**: `src/recipes/import/ocr/ocr.controller.ts`, `src/recipes/import/ocr/ocr.service.ts`, `src/recipes/import/ocr/providers/textract.provider.ts`, `src/recipes/import/ocr/ocr.interface.ts`
...
**Priority**: P2 | **Effort**: XS | **Depends on**: T-007
...
**Files**: `src/recipes/import/import.controller.ts`
...
| ----- | ---------------------------------------------- | -------- | ------ | -------------------------- |
| T-001 | DB Migration: import columns                   | P1       | S      | —                          |
| T-002 | Recipe entity extension                        | P1       | S      | T-001                      |
| T-003 | POST /v1/recipes/import/url                    | P1       | M      | T-002                      |
| T-004 | Schema.org extractor                           | P1       | M      | T-003                      |
| T-005 | Fallback extractors (microdata/RDFa/heuristic) | P1       | L      | T-004                      |
| T-006 | Deduplication logic                            | P1       | S      | T-003                      |
| T-007 | Paywall detection                              | P1       | S      | T-003                      |
| T-008 | POST /v1/recipes/import/file                   | P1       | M      | T-002                      |
| T-009 | POST /v1/recipes/import/instagram              | P2       | M      | T-003, T-004               |
| T-010 | POST /v1/recipes/{id}/clone                    | P1       | M      | T-002                      |
| T-011 | Attribution display component (web)            | P1       | S      | T-003, T-004               |
| T-012 | Import UI — web                                | P1       | M      | T-003, T-008, T-009, T-010 |
| T-013 | Import UI — mobile                             | P2       | M      | T-012                      |
| T-014 | Integration tests                              | P1       | M      | T-003–T-013                |
| T-015 | OCR import (physical copy)                     | P3       | L      | T-002, T-013               |
| T-016 | GET /v1/recipes/import/sources                 | P2       | XS     | T-007                      |

**Total tasks**: 16
**P1 (must-have)**: T-001 through T-012, T-014 (13 tasks)
**P2 (should-have)**: T-009, T-013, T-016 (3 tasks)
**P3 (nice-to-have)**: T-015 (1 task)
