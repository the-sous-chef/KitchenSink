/** @module @kitchensink/config — Unified configuration system for all Sous Chef apps and services */
...
export const ssmConfigSchema = z.object({
     ...
     *
     * Example: `/souschef/production/DATABASE_URL`
     */
    prefix: z.string().default('/souschef'),
...
export const auth0ConfigSchema = z.object({
    /** Auth0 tenant domain (e.g., `souschef.us.auth0.com`). */
 ...
 *     ssm: { prefix: '/souschef', region: 'us-east-1' },
 *   });
 *
