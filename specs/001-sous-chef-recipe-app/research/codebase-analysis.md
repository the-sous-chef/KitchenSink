# Codebase Analysis: Sous Chef Recipe App
...
| --------------------------------------- | ------------------------------ | --------------------------------------- |
| `packages/apps/sous-chef/api`           | NestJS backend on Fargate      | `packages/apps/sous-chef/api`           |
| `packages/apps/sous-chef/lambda-photos` | Lambda photo processor (Sharp) | `packages/apps/sous-chef/lambda-photos` |
...
packages/ui (shared components)
    ↑
    ├── packages/apps/sous-chef/web (Next.js 15)
    │       └── packages/apps/sous-chef/api (NestJS REST)
    │              ├── packages/apps/sous-chef/lambda-photos
    │              └── AWS (S3, SQS, RDS)
    │
    └── packages/apps/sous-chef/mobile (Expo 53)
            └── packages/apps/sous-chef/api (NestJS REST)
```
