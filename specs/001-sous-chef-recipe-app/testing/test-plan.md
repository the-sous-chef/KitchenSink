# Test Plan: Sous Chef Recipe Management Core

**Feature**: `001-sous-chef-recipe-app`
**Testing Strategy**: TDD (tests written before implementation)
**Testing Directory**: `specs/001-sous-chef-recipe-app/testing/`
**Source Artifacts**:
...
npx playwright test testing/playwright-tests/001-sous-chef-recipe-app/system-tests.spec.ts

# Run acceptance tests (requires full environment)
npx playwright test testing/playwright-tests/001-sous-chef-recipe-app/acceptance-tests.spec.ts
```
