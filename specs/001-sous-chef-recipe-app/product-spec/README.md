# Product Spec: Sous Chef Recipe Management Core
...
This directory contains the Product Forge v1.3.0 product specification artifacts for the Sous Chef Recipe Management Core feature.
