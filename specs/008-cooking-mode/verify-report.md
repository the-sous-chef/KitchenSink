...
| ------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| code ↔ tasks              | ⚠️ EXPECTED-GAP | 0/32 tasks complete; no cooking-mode implementation files exist yet under `packages/shared/src/cooking`, `packages/apps/sous-chef/web/src/features/cooking-mode`, or `packages/apps/sous-chef/mobile/src/features/cooking-mode` |
