...
| REQ-IF-003 | The system SHALL enforce authentication via the Auth0 integration from feature 002-auth0-user-auth for all meal planning operations.                             | P1       | All meal planning requires authentication; hard dependency on 002. Derived from Dependencies table.                              | Test                |
...
- **002-auth0-user-auth** (Required): Provides authentication and user identity for all meal planning operations.
