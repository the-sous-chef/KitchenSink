...
| [002-usda-food-data](../002-usda-food-data/spec.md)             | **Required** — nutritional summaries depend on food data                             |
| [003-auth0-user-auth](../003-auth0-user-auth/spec.md)           | **Required** — all meal planning requires authentication                             |
