...
**Target Source File(s)**: `packages/apps/sous-chef/web/app/api/auth/[...clerk]/route.ts`
...
**Target Source File(s)**: `packages/apps/sous-chef/mobile/lib/auth/idp-client.ts`
