...
**Evidence**: `REQ-CN-001` ("AI Integration MUST depend on Recipe entities from spec 001-commise-recipe-app") is listed with `Verification Method: Inspection` and no ATP-ID in Matrix A:
