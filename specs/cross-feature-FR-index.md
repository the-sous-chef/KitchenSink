...
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------- | ------ |
| [`002-user-auth/spec.md`](./002-user-auth/spec.md)                             | [`001-sous-chef-recipe-app`](./001-sous-chef-recipe-app/spec.md) | `001-FR-045`              | Auth0 provides the authentication dependency required by the recipe app.  | Active |
