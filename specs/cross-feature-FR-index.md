...
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------- | ------ |
| [`002-auth0-user-auth/spec.md`](./002-auth0-user-auth/spec.md)                             | [`001-sous-chef-recipe-app`](./001-sous-chef-recipe-app/spec.md) | `001-FR-045`              | Auth0 provides the authentication dependency required by the recipe app.  | Active |
| [`002-auth0-user-auth/spec.md`](./002-auth0-user-auth/spec.md)                             | [`003-usda-food-data`](./003-usda-food-data/spec.md)             | `003-FR-035`              | Auth0 provides the shared API Gateway authorizer used by USDA food data.  | Active |
| [`002-auth0-user-auth/spec.md`](./002-auth0-user-auth/spec.md)                             | [`005-ai-integration`](./005-ai-integration/spec.md)             | `005-FR-018`              | External agent OAuth builds on the authentication layer.                  | Active |
| [`002-auth0-user-auth/spec.md`](./002-auth0-user-auth/spec.md)                             | [`010-subscriptions`](./010-subscriptions/spec.md)               | `010-FR-040`–`010-FR-043` | Account stores subscription tier/state consumed by Auth0 account context. | Active |
