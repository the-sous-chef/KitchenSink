...
| SYS-011 | Auth Integration Adapter           | Wraps the 002-auth0-user-auth service to authenticate all requests and resolve trainer-client user relationships.                                                              | REQ-IF-004, REQ-CN-001    | Subsystem |
