...
| SYS-010 | Recipe App Integration Adapter     | Wraps the 001-commise-recipe-app API to obtain recipe-level nutritional data as the basis for compliance calculations.                                                       | REQ-IF-003, REQ-CN-001    | Subsystem |
