...
| REQ-IF-004 | The system SHALL integrate with the Auth0 User Auth feature (002-auth0-user-auth) to authenticate all users, enforce trainer-client user relationships.                          | P1       | All features require authentication; trainer-client model requires user relationships; derived from the Dependencies section (002-auth0-user-auth: Required). | Test                |
...
- **002-auth0-user-auth** (Required): All features require authentication; trainer-client model requires user relationships.
