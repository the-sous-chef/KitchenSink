---
description:
  Run deterministic impact analysis to identify all V-Model artifacts affected
...
scripts:
  sh: .specify/scripts/bash/impact-analysis.sh
  ps: .specify/scripts/powershell/impact-analysis.ps1
---
